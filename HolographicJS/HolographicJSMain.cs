...
namespace HolographicJS
{
    ...
    /// </summary>
    internal class HolographicJSMain : IDisposable
    {
        // ChakraCore host for our JS application
        ChakraHost host;

        // The JS script that will be run
        string appScript;
        ...
        public HolographicJSMain(DeviceResources deviceResources)
        {
        ...
        private async Task RunAppScript()
        {
            // Register ChakraHost
            //try
            //{
